...
class DiffUtils:
    ...
    def is_major_change(diff_result: Dict[str, Any], threshold: float = 0.3) -> bool:
        ...
        changed_count = (
            summary.get("changed_fields", 0) +
            summary.get("added_fields", 0) +
            summary.get("removed_fields", 0)
        )
    ...
    @staticmethod
    def compare_proposals(proposal1_content: Dict[str, Any], 
                         proposal2_content: Dict[str, Any]) -> Dict[str, Any]:
        """比较两个方案版本的完整差异
...
# 便捷函数
def compare_versions(version1_content: Dict[str, Any], 
                     version2_content: Dict[str, Any]) -> Dict[str, Any]:
    """便捷的版本比较函数

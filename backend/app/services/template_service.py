...
class TemplateService:
    ...
    def __init__(self):
        # 创建Jinja2环境，禁用自动转义以支持Markdown内容
    ...
    def preview_template(self, template_content: str, sample_variables: Dict[str, Any]) -> str:
        """
        预览模板渲染效果
    ...
    def create_proposal_from_template(
        self, template_content: str, customer_name: str, requirements: str, **additional_vars
    ) -> str:
        """
        从模板创建方案
